...
public class MD5Util {
	...
	/*
	 * digest,是最新一次计算结果的2进制内部表示，表�?28bit的keyBean�?
	 */
	private byte[] digest = new byte[16];

	/*
	 * getkeyBeanofStr是类keyBean�?��要的公共方法，入口参数是你想要进行keyBean变换的字符串
	 * 返回的是变换完的结果，这个结果是从公共成员digestHexStr取得的．
	 */
	public String md5Password(String inbuf) {
		keyBeanInit();
	...
	// 这是keyBean这个类的标准构�?函数，JavaBean要求有一个public的并且没有参数的构�?函数
	public MD5Util() {
		keyBeanInit();
		return;
	}
	...
	/*
	 * F, G, H ,I �?个基本的keyBean函数，在原始的keyBean的C实现中，由于它们�?
	...
	/*
	 * keyBeanMemcpy是一个内部使用的byte数组的块拷贝函数，从input的inpos�?��把len长度�?
